    ...
    def forward(self,
        ...
        if targets_aa is not None:
            ...
            aa_masked_lm_loss = aa_loss_fct(
                aa_logit_out.view(-1, self.num_aa_classes), targets_aa.view(-1))
        ...
        if targets_ss is not None:
            ...
            ss_ce_loss = ss_loss_fct(
                ss_logit_out.view(-1, self.num_ss_classes), targets_ss.view(-1))
        ...
        if targets_rsa is not None:
            ...
            rsa_ce_loss = rsa_loss_fct(
                rsa_logit_out.view(-1, self.num_rsa_classes), targets_rsa.view(-1))
        ...
        if targets_dist is not None:
            ...
            dist_ce_loss = dist_loss_fct(
                dist_logit_out.view(-1, self.num_dist_classes), targets_dist.view(-1))
