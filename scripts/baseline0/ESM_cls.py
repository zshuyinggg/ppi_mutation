...
if __name__ == '__main__':
    ...
    proData = ProteinDataModule(**config,logger=logger)
    ...
    test_data = ProteinDataModule(logger=logger,clinvar_csv=pj(data_path, 'clinvar/mutant_seq_2019_test_no_error.csv'),
