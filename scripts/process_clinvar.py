...
if __name__ == '__main__':
    preprocess_variant_sum_file=MultiProcessClinvar(variant_summary_file=pj(data_path,'clinvar/variant_summary_2019-01.txt'),\
    ...
    f_final_mutant.to_csv('mutant_seq_2019_1.csv')
